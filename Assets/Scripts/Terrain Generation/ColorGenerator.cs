...
public class ColorGenerator : MonoBehaviour
{
    ...
    public void assignColors() // lots of maths to work out the color 
    {
        ...
        for (int i = 0; i < Tmesh.vertexCount / 3; i++)
        {
            ...
            Vector3 v3 = verts[(i * 3) + 2]; // works out gradients of triangles
    ...
    Texture2D avgTex(Texture2D tex1, Texture2D tex2) // merges two textures together
    {
